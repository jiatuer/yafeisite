...
' ============================================
Sub Header(str)
	Response.Write "<HTML><HEAD><TITLE>eWebEditor在线编辑器 - 例子：文章系统</TITLE><style>body,p,td,input {font-size:9pt}</style></HEAD><BODY>"
	Response.Write "<p align=center><a href='list.asp'>文章列表</a> | <a href='add.asp'>增加文章</a></p>"
