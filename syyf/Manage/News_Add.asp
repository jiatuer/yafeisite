...
'===== End 图片新闻处理	
	...
	rs.Close
	Set rs=nothing
	Response.Write "<script language='javascript'>alert('新闻添加成功!');document.location.href('News_Add.asp');</script>"
	Response.End()
else
%>
...
%>
              ...
              <td height="40" align="left" valign="middle" class="bline">作者：
                ...
                来源： 
                <input name="from" type="text" class="main" id="from" size="20" maxlength="100" value="本站"></td>
            </tr>
            <tr>
              <td height="30" align="right" valign="middle" class="bline"><span class="t3">其他项：</span></td>
            ...
            <tr>
              ...
              <td height="40" align="left" valign="middle" class="bline">调用一：
            ...
            <tr>
              <td height="30" align="right" valign="middle" class="bline"><span class="t3">备用项：</span></td>
              <td height="40" align="left" valign="middle" class="bline">调用三：
