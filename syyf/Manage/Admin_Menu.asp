...
<TABLE width=98% height=30 border=0 align="center" cellPadding=0 cellSpacing=0 
  ...
  <TBODY>
    <TR>
      <TD>　<strong><font color="#006699">反馈类型下拉菜单管理</font></strong></TD>
    </TR>
  </TBODY>
</TABLE>
...
%>
          <tr>
            ...
            <td bgcolor="#F0F0F0" align="center" height="22" width="16%"> <a href="Admin_Action.asp?Action=4&id=<%=rs("Type_id")%>">删</a></td>
          </tr>
          <%
 rs.movenext
 Next
...
%>
          <tr>
            <td bgcolor="#E3E3E3" align="center" colspan="3" height="20"><b> <u><a href="Admin_Menu.asp?action=2">新增下拉菜单</a></u></b> <font color="#800000"><b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Admin_Action.asp?Action=5"> <font color="#FF0000">所有数据清空(慎用)</font></a></b></font></td>
          </tr>
        </table>
      </div></TD>
    </TR>
    ...
    <TR bgColor=#fafafa>
      <TD height=80><div align=center>
        <table width="98%" height="63" border="0" align="center" id="table4">
          ...
          <form method="POST" action="Admin_Action.asp?action=2" name="YuQaIFS_Feedback_Add">
            <tr>
...
%>
        <table width="98%" height="63" border="0" align="center" id="table4">
          ...
          <form method="POST" action="Admin_Action.asp?action=3&id=<%=id%>" name="YuQaIFS_Feedback_Modi">
            <tr>
