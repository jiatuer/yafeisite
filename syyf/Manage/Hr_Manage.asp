...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
	<%
	sql="select * from xin_Hr order by tid asc,ord asc"
            ...
            <td height="25" colspan="4" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 %>
	          <tr>
                ...
                <td width="25%" height="25" align="center" valign="middle"><a href="Hr_Edit.asp?id=<%=rs("id")%>">修改</a> | <a href="Hr_Del.asp?id=<%=rs("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a></td>
              </tr>
			  <%
			  pages = pages - 1
			  rs.movenext
