...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
	<%
	sql="select * from xin_Index_Type where pid=0 order by ord asc"
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="ta">
      ...
      <tr>
        <td height="25" align="right" valign="middle" class="tb"><table width="100%" border="0" cellpadding="0" cellspacing="1" class="ta">
          <tr>
            <td width="30%" height="25" align="center" valign="middle" class="tb">栏目名称</td>
          ...
          <tr>
            <td height="25" colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 %>
	          <tr>
                <td width="30%" height="25" align="center" valign="middle"><%=rs("name")%></td>
                <td width="30%" align="center" valign="middle"><%=rs("ord")%></td>
                <td width="40%" height="25" align="center" valign="middle"><a href="New_Type_Edit.asp?id=<%=rs("id")%>">修改</a> | <a href="New_Type_Del.asp?id=<%=rs("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a> &nbsp;[<a href="New_Type_Add.asp?pid=<%=rs("id")%>">添加二级分类</a>]</td>
              </tr>
			  <%
			  sql1="select * from xin_Index_type where pid="&rs("id")&" order by ord asc"
	          ...
	          <tr>
	            ...
	            <td height="30" align="center" valign="middle" class="ej">--&gt;&nbsp;[<a href="New_Type_Edit.asp?id=<%=js("id")%>">修改</a>]&nbsp;[<a href="New_Type_Del.asp?id=<%=js("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a>]</td>
	            </tr>
			  <%
			  js.movenext
			  loop
