            ...
            <td height="25" colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 %>
	          <tr>
                ...
                <td width="40%" height="25" align="center" valign="middle"><a href="Show_Type_Edit.asp">修改</a> | <a href="Show_Type_Del.asp?id=<%=rs("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a>&nbsp;[<a href="Show_Type_Add.asp?pid=<%=rs("id")%>">添加二级分类</a>]</td>
              </tr>
			  <%
			  sql1="select * from xin_Show_Info where pid="&rs("id")&" order by ord asc"
			  set js=server.CreateObject("ADODB.Recordset")
			  js.open sql1,conn,1,1
			  do while not js.eof
			  %>
	          <tr>
	            <td height="30" align="center" valign="middle" class="ej">--&gt;&nbsp;<%=js("title")%></td>
	            <td height="30" align="center" valign="middle" class="ej">--&gt;&nbsp;<%=js("ord")%></td>
	            <td height="30" align="center" valign="middle" class="ej">--&gt;&nbsp;[<a href="Show_Type_Edit.asp">修改</a>]&nbsp;[<a href="Show_Type_Del.asp?id=<%=js("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a>]</td>
	            </tr>
			  <%
			  js.movenext
			  loop
