...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
	<%
	sql="select * from xin_Show order by id desc"
            ...
            <td height="25" colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 %>
	          <tr>
				...
				%></td>
                <td width="30%" height="25" align="center" valign="middle"><a href="Show_Edit.asp?id=<%=rs("id")%>">修改</a> | <a href="Show_Del.asp?id=<%=rs("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a></td>
              </tr>
			  <%
			  pages = pages - 1
			  rs.movenext
