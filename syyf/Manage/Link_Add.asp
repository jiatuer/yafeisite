...
if Request("Action")=1 then
	...
	rs.Close
	Set rs=nothing
	Response.Write "<script language='javascript'>alert('您成功添加了一个友情链接!');document.location.href('Link_Manage.asp');</script>"
	Response.End()
else
%>
        ...
        <td colspan="2" align="left" valign="top" bgcolor="#FFFFFF">
		  ...
		  <form name="form1" method="post" action="?action=1">
            <tr>
              ...
              <td width="70%" height="30" align="left" valign="middle"><input name="name" type="text" class="main" id="name" size="30" maxlength="30"></td>
            </tr>
            <tr>
              <td width="30%" height="30" align="right" valign="middle" class="t3">站点网址：</td>
              <td width="70%" height="30" align="left" valign="middle"><input name="url" type="text" class="main" id="url" size="30" maxlength="100">
                <span class="ts">*请以http://开头</span></td>
            </tr>
            <tr>
              <td width="30%" height="30" align="right" valign="middle" class="t3">站点Logo：</td>
              <td width="70%" height="30" align="left" valign="middle"><input name="logo" type="text" class="main" id="logo" size="30" maxlength="100">
                <span class="ts">*请以http://开头</span></td>
            </tr>
            <tr>
              <td width="30%" height="30" align="right" valign="middle" class="t3">显示顺序：</td>
              <td width="70%" height="30" align="left" valign="middle"><input name="ord" type="text" class="main" id="ord" value="0" size="4" maxlength="4">
                <span class="ts">*数值越小越靠前</span></td>
            </tr>
            <tr>
              <td width="30%" height="50" align="right" valign="middle" class="t3">站点说明：</td>
              <td width="70%" height="30" align="left" valign="middle"><textarea name="info" cols="30" rows="3" id="info"></textarea></td>
            </tr>
            <tr>
