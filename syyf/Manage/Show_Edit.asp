...
<%
	...
	Response.Write "<script language='javascript'>alert('参数错误!');document.location.href('Show_Manage.asp');</script>"
	Response.End()
	end if
...
if Request("Action")=1 then
	...
	rs.Close
	Set rs=nothing
	Response.Write "<script language='javascript'>alert('产品修改成功!');document.location.href('Show_Manage.asp');</script>"
	Response.End()
else
%>
        ...
        <td colspan="2" align="left" valign="top" bgcolor="#FFFFFF">
		  ...
		  <form name="form1" method="post" action="?action=1&id=<%=request("id")%>" onSubmit="return Validator.Validate(this,3);">
            ...
            <tr>
              ...
              <td width="40%" height="120" align="left" valign="middle" class="bline"><iframe allowTransparency="true" name='i1' src='upload/upload_pic.asp'; frameborder=0 width="350" scrolling=no height="40"> </iframe>
