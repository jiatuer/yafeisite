...
if Request("Action")=1 then
	...
	rs.Close
	Set rs=nothing
	Response.Write "<script language='javascript'>alert('产品发布成功!');document.location.href('Product_Add.asp');</script>"
	Response.End()
else
%>
...
%>
            ...
            <tr>
              <td height="30" align="right" valign="middle" class="bline"><span class="t3">上传图片（用于缩略图）：<br>
              </span></td>
