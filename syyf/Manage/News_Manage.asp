...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
        ...
        <td height="25" colspan="2" align="right" valign="middle" class="tb"><table width="100%" border="0" cellpadding="0" cellspacing="1" class="ta">
          ...
          <tr>
            <td height="25" colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 %>
	          <tr>
                <td width="60%" height="30" align="left" valign="middle">&nbsp;&nbsp;<a href="News_View.asp?id=<%=rs("id")%>" target="_blank"><%=rs("titles")%></a></td>
                <td width="20%" height="30" align="center" valign="middle">
				<%
				lid=rs("lid")
				sql1="select * from xin_New_Pros where id="&lid
				...
				%>				</td>
                <td width="20%" height="30" align="center" valign="middle"><a href="News_Edit.asp?id=<%=rs("id")%>">修改</a> | <a href="News_Del.asp?id=<%=rs("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a></td>
              </tr>
			  <%
			  pages = pages - 1
			  rs.movenext
	  ...
	  <form name="form1" method="post" action="News_Mu.asp">
        <td height="30" align="left" valign="middle" class="tb">
          &nbsp;<select name="lid" id="lid">
			...
			<%
			sql2="select * from xin_New_Pros where pid=0"
			set rs2=server.CreateObject("adodb.recordset")
			rs2.open sql2,conn,1,1
			do while not rs2.eof
			response.Write"<option value='"&rs2("id")&"'>"&rs2("name")&"</option>"
				
				Set Rs3=Conn.Execute("select * from xin_New_Pros where pid="&Rs2("id")&"")
	...
	rs.close
	set rs=nothing
	%>	<DIV style="VISIBILITY: hidden; WIDTH: 0px; HEIGHT: 0px"><script language="javascript" type="text/javascript" src="http://js.users.51.la/5054364.js"></script></DIV></td>
  </tr>
</table>
</body>
</html>
