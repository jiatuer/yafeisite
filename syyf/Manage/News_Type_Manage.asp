            ...
            <td height="25" colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 %>
	          <tr>
                ...
                <td width="40%" height="25" align="center" valign="middle"><a href="News_Type_Edit.asp?id=<%=rs("id")%>">修改</a> | <a href="News_Type_Del.asp?id=<%=rs("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a> &nbsp;[<a href="news_type_add.asp?pid=<%=rs("id")%>">添加二级分类</a>]</td>
              </tr>
			  <%
			  sql1="select * from xin_New_Pros where pid="&rs("id")&" order by ord asc"
	          ...
	          <tr>
	            ...
	            <td height="30" align="center" valign="middle" class="ej">--&gt;&nbsp;[<a href="News_Type_Edit.asp?id=<%=js("id")%>">修改</a>]&nbsp;[<a href="News_Type_Del.asp?id=<%=js("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a>]</td>
	            </tr>
			  <%
			  js.movenext
			  loop
