...
'===== End 图片新闻处理	
	...
	rs.Close
	Set rs=nothing
	Response.Write "<script language='javascript'>alert('修改成功!');document.location.href('New_Manage.asp');</script>"
	Response.End()
else
%>
...
%>
            ...
            <tr class="bline">
              ...
              <td height="30" align="left" valign="middle" class="bline"><input name="from" type="text" class="main" id="from" value="<%=rs("from")%>" size="15" maxlength="20"></td>
            </tr>
            <tr>
