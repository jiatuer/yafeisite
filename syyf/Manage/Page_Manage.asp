...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
	<%
	sql="select * from xin_Page order by tid asc,ord asc"
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="ta">
      <tr>
        <td width="87%" height="25" align="left" valign="middle" class="t2">单页列表</td>
        </tr>
      <tr>
            ...
            <td height="25" colspan="4" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 %>
	          <tr>
                ...
                <td width="25%" height="25" align="center" valign="middle"><a href="Page_Edit.asp?id=<%=rs("id")%>">修改</a> | <a href="Page_Del.asp?id=<%=rs("id")%>" ONCLICK="javascript:return confirm('提示：您确定要继续执行该操作吗？')">删除</a></td>
              </tr>
			  <%
			  pages = pages - 1
			  rs.movenext
